...
public class UserManagementTest {
    ...
    public void testAddNewUser() {
        ...
        userManagementPage.enterEmployeeName("Navyasree");
        userManagementPage.enterUsername("Navya sree");
       ...
       // Assert.assertTrue(userManagementPage.isUserInUserList("Navyasree"), "User does not appear in the user list.");
    }
